...
particles += [RedParticle(Position(x=random.randint(-int(board.width / 2), int(board.width / 2)),
                                   y=random.randint(-int(board.height / 2), int(board.height / 2)))) for _ in range(50)]
...
manager = pygame_gui.UIManager((board.height, board.width))

blue_blue_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 10), (200, 25)),
                                                          start_value=float(
                                                              law_of_attraction.get((Color.BLUE, Color.BLUE), 0)),
                                                          value_range=(-2, 2), click_increment=0.1,
                                                          manager=manager)
blue_blue_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 10), (150, 25)),
                                              text=f"blue-blue: {blue_blue_slider.get_current_value()}",
                                              manager=manager)

blue_green_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 50), (200, 25)),
                                                           start_value=float(
                                                               law_of_attraction.get((Color.BLUE, Color.GREEN), 0)),
                                                           value_range=(-2, 2), click_increment=0.1,
                                                           manager=manager)
blue_green_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 50), (150, 25)),
                                               text=f"blue-green: {blue_green_slider.get_current_value()}",
                                               manager=manager)

blue_red_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 90), (200, 25)),
                                                         start_value=float(
                                                             law_of_attraction.get((Color.BLUE, Color.RED), 0)),
                                                         value_range=(-2, 2), click_increment=0.1,
                                                         manager=manager)
blue_red_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 90), (150, 25)),
                                             text=f"blue-red: {blue_red_slider.get_current_value()}", manager=manager)

green_green_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 130), (200, 25)),
                                                            start_value=float(
                                                                law_of_attraction.get((Color.GREEN, Color.GREEN), 0)),
                                                            value_range=(-2, 2), click_increment=0.1,
                                                            manager=manager)
green_green_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 130), (150, 25)),
                                                text=f"green-green: {green_green_slider.get_current_value()}",
                                                manager=manager)

green_red_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 170), (200, 25)),
                                                          start_value=float(
                                                              law_of_attraction.get((Color.GREEN, Color.RED), 0)),
                                                          value_range=(-2, 2), click_increment=0.1,
                                                          manager=manager)
green_red_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 170), (150, 25)),
                                              text=f"green-red: {green_red_slider.get_current_value()}",
                                              manager=manager)

green_blue_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 210), (200, 25)),
                                                           start_value=float(
                                                               law_of_attraction.get((Color.GREEN, Color.BLUE), 0)),
                                                           value_range=(-2, 2), click_increment=0.1,
                                                           manager=manager)
green_blue_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 210), (150, 25)),
                                               text=f"green-blue: {green_blue_slider.get_current_value()}",
                                               manager=manager)

red_green_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 250), (200, 25)),
                                                          start_value=float(
                                                              law_of_attraction.get((Color.RED, Color.GREEN), 0)),
                                                          value_range=(-2, 2), click_increment=0.1,
                                                          manager=manager)
red_green_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 250), (150, 25)),
                                              text=f"red-green: {red_green_slider.get_current_value()}",
                                              manager=manager)

red_red_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 290), (200, 25)),
                                                        start_value=float(
                                                            law_of_attraction.get((Color.RED, Color.RED), 0)),
                                                        value_range=(-2, 2), click_increment=0.1,
                                                        manager=manager)
red_red_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 290), (150, 25)),
                                            text=f"red-red: {red_red_slider.get_current_value()}", manager=manager)

red_blue_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 330), (200, 25)),
                                                         start_value=float(
                                                             law_of_attraction.get((Color.RED, Color.BLUE), 0)),
                                                         value_range=(-2, 2), click_increment=0.1,
                                                         manager=manager)
red_blue_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 330), (150, 25)),
                                             text=f"red-blue: {red_blue_slider.get_current_value()}", manager=manager)
...
reduc_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 390), (200, 25)),
                                                      ...
                                                      manager=manager)
reduc_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 390), (150, 25)),
                                          text=f"reduc: {reduc_slider.get_current_value()}", manager=manager)
...
zone_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 430), (200, 25)),
                                                     ...
                                                     manager=manager)
zone_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 430), (150, 25)),
                                         text=f"zone: {zone_slider.get_current_value()}", manager=manager)
...
min_slider = pygame_gui.elements.UIHorizontalSlider(relative_rect=pygame.Rect((10, 470), (200, 25)),
                                                    ...
                                                    manager=manager)
min_label = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((210, 470), (150, 25)),
                                        text=f"min: {min_slider.get_current_value()}", manager=manager)
...
while running:
    ...
    for particle in particles:
        pygame.draw.circle(screen, color=particle.species.value,
